...
public class CacheWarmingService : BackgroundService
{
    ...
    private readonly ServicoVideosCacheRobo _cacheService;
    ...
    public CacheWarmingService(
        ...
        ServicoVideosCacheRobo cacheService)
    {
        _logger = logger;
    ...
    private async Task ListarCategorias(ServicoVideosCacheRobo cacheService, CancellationToken stoppingToken)
    {
        try
        {
            await _semaphore.WaitAsync(stoppingToken);
