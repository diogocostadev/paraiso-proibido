...
public class RoboAtualizaBaseInteira : BackgroundService
{
    private readonly ILogger<RoboAtualizaBaseInteira> _logger;
    ...
    public RoboAtualizaBaseInteira(ILogger<RoboAtualizaBaseInteira> logger, IConfiguration _configuration)
    {
